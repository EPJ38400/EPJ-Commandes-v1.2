...
function Router() {
  ...
  // Force le retour à l'accueil quand l'app reprend le focus
  // (cas PWA iOS : l'app est "réveillée" après avoir été en arrière-plan)
  useEffect(() => {
    ...
    // Aussi sur le focus de la fenêtre (cas navigateur classique)
