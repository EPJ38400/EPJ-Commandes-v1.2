...
export function ParcOutilTransfert({ outil, sortie, onBack, onDone }) {
  ...
  // Destinataire du transfert = n'importe quel membre de l'équipe
  // (sauf le détenteur actuel, aucun sens de se transférer à soi-même)
  const eligibleUsers = useMemo(() => {
    return [...users]
      .filter(u => u.id !== sortie.emprunteurId)
