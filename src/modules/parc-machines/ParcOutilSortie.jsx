...
export function ParcOutilSortie({ outil, onBack, onDone }) {
  ...
  // Emprunteur possible = TOUS les utilisateurs de l'équipe
  // Le droit canSortirOutil concerne QUI peut déclencher une sortie (toi, Admin),
  // pas QUI peut être l'emprunteur (n'importe quel membre de l'équipe)
