...
//  - Header avec logo couleur EPJ (PNG transparent)
//  - Arcs colorés de la charte EPJ en filigrane d'arrière-plan
// ═══════════════════════════════════════════════════════════════
import { EPJ, font, globalCss } from "./theme";
import { LOGO_HEADER, BG_LOGIN } from "./logo";
import { useAuth } from "./AuthContext";

export function Layout({ children, currentModule, onHome }) {
...
// ─── Header global (affiché une fois connecté) ──────────────────
function Header({ user, currentModule, onHome, onLogout }) {
  return (
    <header style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ textAlign: "right", lineHeight: 1.2 }}>
            ...
            <div style={{
              fontSize: 10, fontWeight: 500, color: EPJ.gray500,
